...
async def main():
    coords_list = [get_random_us_coord() for _ in range(15)] # TOTAL AMOUNT OF COORD ENTRIES
    ...
    with open(file_path, mode='a', newline='') as f:
        ...
        for i, coords in enumerate(coords_list):
            ...
            print(f"Calculating OSM feature densities at ({coords})...")
            osm_features = get_osm_features(coords, 1000)
